...
| [Design of Computer Programs](https://www.udacity.com/course/design-of-computer-programs--cs212) | Free course on designing solutions in Python, using Peter Norvig's problem-solving techniques and clean coding style. By Peter Norvig & Udacity | All levels | Free |
| [Epic React](https://epicreact.dev/) | A series of courses on advanced React concepts, covering testing and architecting of React applications as well as user experience. Courses by Kent C. Dodds | Intermediate, Advanced | Pay a standalone fee to get a series of workshops. Prices vary based on IP address; in Australia it's $264 for standard (4 workshops), $119 for basic (2 workshops) and $599 for premiuim (8 workshops)|
